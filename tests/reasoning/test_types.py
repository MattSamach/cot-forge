...
class TestSerializationDeserialization(unittest.TestCase):
  ...
  def test_round_trip_serialization(self):
    ...
    self.strategy_registry.get_strategy = MagicMock(
        return_value=self.mock_strategy)
    ...
    self.assertEqual(deserialized.ground_truth_answer,
                     self.search_result.ground_truth_answer)
    ...
    self.assertEqual(len(deserialized.terminal_nodes),
                     len(self.search_result.terminal_nodes))
